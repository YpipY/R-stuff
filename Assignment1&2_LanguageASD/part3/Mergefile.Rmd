...
```{r}
# Loading data
demo<-read.csv("demo_test.csv",stringsAsFactors = F)
lu<-read.csv("LU_test.csv",stringsAsFactors = F)
token<-read.csv("token_test.csv",stringsAsFactors = F)
#Loading packages
library(dplyr)
library(plyr)
library(stringr)
...
```{r}
# Saving the dataset
write.csv(ADSFinal, file = "test.csv")
```

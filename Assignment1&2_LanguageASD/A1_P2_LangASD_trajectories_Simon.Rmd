...
languageModel2 = lmer(CHI_MLU ~ Diagnosis + 1 + VISIT + I(VISIT^2) + (1+VISIT+ I(VISIT^2)|SUBJ), data=data, REML=FALSE)
summary(languageModel2)
r.squaredGLMM(languageModel2)
languageNull2 = lmer(CHI_MLU ~ 1 + VISIT + I(VISIT^2) + (1+VISIT+ I(VISIT^2)|SUBJ), data=data, REML=FALSE)
...
languageModelMot = lmer(MOT_MLU ~ Diagnosis + 1 + VISIT + I(VISIT^2) + (1+VISIT+ I(VISIT^2)|SUBJ), data=data, REML=FALSE)
summary(languageModelMot)
r.squaredGLMM(languageModelMot)
languageNullMot = lmer(MOT_MLU ~ 1 + VISIT + I(VISIT^2) + (1+VISIT+ I(VISIT^2)|SUBJ), data=data, REML=FALSE)

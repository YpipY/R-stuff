...
for (i in files){
  ...
  data[n,7] <- median(temp2$f0)
  data[n,8] <- quantile(temp2$f0, probs=0.05)
  data[n,9] <- quantile(temp2$f0, probs=0.25)
  data[n,10] <- quantile(temp2$f0, probs=0.75)
  data[n,11] <- quantile(temp2$f0, probs=0.95)
}
quantile(temp2$f0, probs=0.05)
data[n,5] <- mean(temp2$f0)
mean<-mean(temp2$f0)
data[n,5] <- mean
mean(temp2$f0)

...
In conclusion, Diagnosis cannot be predicted from acoustic features from voice pitch nor pause. Since none of the model perform better than an accuracy of ~ .65.

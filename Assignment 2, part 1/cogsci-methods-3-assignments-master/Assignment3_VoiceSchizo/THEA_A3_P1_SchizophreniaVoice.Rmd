...
mean (β=15.73 (SE= 4.75), t = 3.31, p<.05)
q05 (β= 21.07 (SE= 5.04), t = 4.18, p<.05)
q25 (β= 18.89 (SE= 4.92), t = 3.84 , p<.05)
median (β= 12.60 (SE= 4.78), t = 2.64 , p<.05)
q75 (β= 13.00 (SE= 5.15), t = 2.53 , p<.05)
q95 (β= 16.40 (SE= 7.57), t = 2.17 , p<.05)
coe.var (β= -0.05 (SE= 0.02), t = -3.18 , p<.05)
MAD (β= -5.30 (SE= 1.52), t = -3.48 , p<.05)

Diagnosis was not a significant predictor for: sd and inter quantile range from q75 - q25.
...
Testing if study is a significant predictor we included study as a fixed effect in the models. 
